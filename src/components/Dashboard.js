...
const Dashboard = () => {
    return(
        <div className="flex pt-5 flex-col lg:grid lg:grid-cols-2 place-items-center  dark:bg-black h-[90%]">
            ...
            <div className="flex flex-col justify-center items-center gap-8 text-black dark:text-white">
                ...
                <div className="mt-3 flex justify-center gap-2">
                    ...
                    <Link to={"/contact"}>
                        <button className="bg-gray-600 text-gray-50 dark:bg-slate-300 font-bold dark:text-slate-900 p-3 rounded-2xl hover:bg-yellow-300 hover:text-black">Contact</button>
                    </Link>
                </div>
            </div>
        </div>
