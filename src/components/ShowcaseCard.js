...
import demo from '../assets/companies/strathclyde.png'
import { useSelector } from 'react-redux'

const ShowcaseCard = ({value}) => {
    ...
    return (
        <div className='w-2/3 h-[400px] flex flex-col lg:grid lg:grid-cols-2 grid-rows-2 border-2 border-red-700 mt-5'>
            ...
            <div className='p-2 flex flex-col h-full w-full'>
                ...
                <div className='text-sm mt-3 lg:hidden'>
                    {shortDesc}
                </div>
                <div className='text-sm mt-3 hidden lg:block'>
                    {desc}
                </div>
                <div className='mt-auto flex justify-between'>
                    <a href={projectLink} className="text-yellow-300" target="_blank" rel="noopener noreferrer">
                    ...
                    {/* <i className={`las la-toggle-off mr-2 cursor-pointer text-black dark:text-white`}></i> */}
                </div>
            </div>
