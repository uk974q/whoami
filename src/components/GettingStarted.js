...
const GettingStarted = () => {
    return(
        <div className="ml-5 mt-5 h-full pr-5">
            <h1 className="font-semibold text-sm my-6 text-red-600 dark:text-green-600">npm i Ullas</h1>
            ...
            <h1 className="font-semibold text-sm my-6 text-red-600 dark:text-green-600">npm clean cache</h1>
        </div>
    )
}
