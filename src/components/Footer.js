...
const Footer = () => {
  ...
  return (
    <div className="bg-slate-200 mt-auto border-x-0 text-black shadow-lg dark:bg-slate-900 dark:bg-gradient-to-t dark:from-black dark:text-white  justify-center flex items-center p-5">
        <a href={FOOTER.githubLink} target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 128 128" className="h-6 w-6 mr-5">
                <g fill={`#${darkMode ? 'fff' : '181616'}`}>
